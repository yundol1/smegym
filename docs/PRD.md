...
#### F-CHALLENGE-02: 챌린지 참여 현황 ⚠️
- 챌린지 기간 내 참여자별 운동 횟수 집계 (참여 현황 있음)
- 목표 달성 여부 표시
...
- workout-photos: 본인 업로드, 인증된 사용자 읽기 (비공개 버킷)
...
### Phase 1: 기반 구축 ✅
- [x] Supabase 프로젝트 생성
- [x] DB 스키마 적용 (테이블, RLS 정책)
- [x] Supabase Auth 설정
- [x] Next.js 프로젝트 구조 재설계 (App Router)
- [x] Supabase 클라이언트 설정

### Phase 2: 핵심 기능 구현 ✅
- [x] 인증 (로그인, 회원가입, 프로필 수정)
- [x] 운동 인증 (사진 업로드, 주간 현황)
- [x] 벌금 계산 및 조회
- [x] 면제 신청/조회
